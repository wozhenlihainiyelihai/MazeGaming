...
class AIPlayer:
    ...
    def interact_with_tile(self, maze, sound_manager):
        ...
        if tile.type == GOLD:
            self.gold += 10; sound_manager.play('coin'); tile.type = PATH
        elif tile.type == HEALTH_POTION:
            self.health = min(100, self.health + 20); sound_manager.play('potion'); tile.type = PATH
